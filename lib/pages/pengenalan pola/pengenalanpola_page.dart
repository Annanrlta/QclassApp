...
class PengenalanPolaPage extends StatelessWidget {
  const PengenalanPolaPage({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        onPressed: (() {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas1PengenalanPola()));
                        }),
                        child: const Padding(
                          padding: EdgeInsets.only(
                            left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas2PengenalanPola()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas3PengenalanPola()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas4PengenalanPola()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
