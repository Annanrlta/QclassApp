...
import 'package:q_class/pages/Pemrograman%20berorientasi%20objek%20lnjut/tugas1.dart';
import 'package:q_class/pages/Pemrograman%20berorientasi%20objek%20lnjut/tugas2pp.dart';
import 'package:q_class/pages/Pemrograman%20berorientasi%20objek%20lnjut/tugas3pp.dart';
import 'package:q_class/pages/Pemrograman%20berorientasi%20objek%20lnjut/tugas4pp.dart';
...
class PemBerorientasiObjekLanjut extends StatelessWidget {
  const PemBerorientasiObjekLanjut({super.key});
          ...
          children: [
            Row(
              children: [
                ...
                // ),
                Text(
                  "Pemrograman Berorientasi Objk Lanjut",
                  style: TextStyle(
                    fontSize: 18,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        onPressed: (() {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas1BerorientObjekLanjut()));
                        }),
                        child: const Padding(
                          padding: EdgeInsets.only(
                            left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas2BerorientObjekLanjut()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas3BerorientObjekLanjut()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas4BerorientObjekLanjut()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
