...
import 'package:q_class/pages/game%20programing/tugas1gp.dart';
import 'package:q_class/pages/game%20programing/tugas2gp.dart';
import 'package:q_class/pages/game%20programing/tugas3gp.dart';
import 'package:q_class/pages/game%20programing/tugas4gp.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        onPressed: (() {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas1GamePrograming()));
                        }),
                        child: const Padding(
                          padding: EdgeInsets.only(
                            left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas2GamePrograming()));
                      },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas3GamePrograming()));
                      },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas4GamePrograming()));
                      },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
