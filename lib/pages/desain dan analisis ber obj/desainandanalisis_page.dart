...
import 'package:q_class/pages/desain%20dan%20analisis%20ber%20obj/Tugas3da.dart';
import 'package:q_class/pages/desain%20dan%20analisis%20ber%20obj/tugas1da.dart';
import 'package:q_class/pages/desain%20dan%20analisis%20ber%20obj/tugas2da.dart';
import 'package:q_class/pages/desain%20dan%20analisis%20ber%20obj/tugas4da.dart';
...
class DesainAnalisisPage extends StatelessWidget {
  const DesainAnalisisPage({super.key});
          ...
          children: [
            Row(
              children: [
                ...
                // ),
                Text(
                  "Desain & Analisis Berorientasi Objek",
                  style: TextStyle(
                    fontSize: 18,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        ...
                        onPressed: (() {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas1DesainAnalisis()));
                        }),
                        child: const Padding(
                          padding: EdgeInsets.only(
                            left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas2DesainAnalisis()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas3DesainAnalisis()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                          Navigator.push(context, MaterialPageRoute(builder: (context) => Tugas4DesainAnalisis()));
                        },
                      child: const Padding(
                        padding: EdgeInsets.only(
                          left: 5,
